...
public class CodeAnalyzer {
	private ArrayList<Object> structureSourceCode; // remaining source code part to be anaylzed
	...
	/**
	 * Constructor to create a new Instance from an existing ArrayList with Structured Code Blocks
	 * @param currentScope // Scope used up to here
	 * @param structureSourceCode // Source Code to be anaylzed
	 */
	 ...
	 */
	public ArrayList<DataInformation> anaylzeBlock(
			String currentScope, 
		...
		// if ArrayList<Object> -> analyzeBlock (recursion!), append resutls to local Symbols
		// return symbols
